...
def get_args():
    ...
    parser.add_argument('--num_steps', type=int, default=256, help='number of steps in an episode or number of forward steps in A2C')
    ...
    parser.add_argument('--save_interval', type=int, default=100, help='save interval, one save per n updates')
    parser.add_argument('--eval_interval', type=int, default=None, help='eval interval, one eval per n updates')
    parser.add_argument('--num_env_steps', type=int, default=10e6, help='number of environment steps to train')
    parser.add_argument('--output_dir', type=str, default='result', help='save all outputs here')
